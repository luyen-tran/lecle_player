...
class LeclePlayerMenus {
  void showQualityOptions(BuildContext context,
      {required Color menuColor,
      required LeclePlayerVideoData currentData,
      required List<LeclePlayerVideoData> allData,
      required Function(LeclePlayerVideoData videoData) onChangedQuality}) {
